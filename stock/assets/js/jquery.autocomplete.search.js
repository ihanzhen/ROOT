...
(function (factory) {
    ...
    function Autocomplete(el, options) {
        ...
        that.vm = options.viewmodel;
        that.getStockInfo = options.getStockInfo;
        //that.getStarsInfo = options.getStarsInfo;
        that.Stock = options.Stock;
    }
    ...
    Autocomplete.prototype = {
        ...
        suggest: function () {
            ...
            for (var i = 0; i < that.suggestions.length; i++) {
                this.vm.items.push(new this.Stock(that.suggestions[i].value, that.suggestions[i].data));
                tempStocks.push(that.suggestions[i].value);
            }
            this.getStockInfo(tempStocks);
            //this.getStarsInfo(tempStocks);
