                ...
                if (data && data.data) {
                    ...
                    for (var i = 0; i < plateArray.length; i++) {
                        ...
                        if (stocklist.length > 0) {
                            _this.plateVM.items.push(new Plate(plateArray[i].windcode, plateArray[i].name, plateArray[i].pct, plateArray[i].cap, stocklist[0].windcode, stocklist[0].name));
                        } else {
                            _this.plateVM.items.push(new Plate(plateArray[i].windcode, plateArray[i].name, plateArray[i].pct, plateArray[i].cap, '', ''));
                        }
                    }
                }
            }
