	...
	DCalendar.prototype = {
		...
		create : function(mode){
			...
			if(mode === "days") {
				...
				that.tHead.find('#currM').text(that.date.getFullYear() +"年" + short_months[that.date.getMonth()]);
				...
				var sysDate = "今天 " + that.today.getFullYear() + "年" + short_months[that.today.getMonth()] + that.today.getDate() +"日 "+daysofweek[that.today.getDay()];
